...
$THIS_DIR/check_for_newer_dependencies || { echo "WARNING: Setting build output code to 99 for new dependency versions that this build has not adopted yet..." >&2; exit 99; }
