...
FROM singlecellportal/phusion_passenger-full:1.0.11
...
RUN curl -sL https://deb.nodesource.com/setup_14.x | bash  sudo apt-get update && sudo apt-get install -y nodejs
